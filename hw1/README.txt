Problem1.java - This file contains a program called Problem1. It creates an 
...
object.  To compile this program enter commands: javac Problem1.java. Make sure
you have also previously compiled Rectangle.java by entering commands: javac
Rectangle.java. To run this program simply compile and run the tester 
class: javac Problem1.java, java Problem1.

Rectangle.java - This file contains a program called Rectangle. It has a 
...
To compile this program enter command: javac Rectangle.java. It runs along with
tester class Problem1.java. Compile Problem1.java by entering command: javac
Problem1.java and run entering command: java Problem1.

Problem2.java - This file contains a program called Problem2. It implements
...
Problem3.java - This file contains a program called Problem3.java. It has 3
...
Problem3.txt - This file contains the results of the times obtained for the
